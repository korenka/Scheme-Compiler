...
module Prims : PRIMS = struct
  ...
  let set_car_impl = 
        ...
        set_car_impl:
          push rbp
          mov rbp, rsp
          mov r9, [rbp+(4)*WORD_SIZE] 
          mov r10, [rbp+(5)*WORD_SIZE] 
          add r9,1 
          mov qword [r9], r10
  ...
  let procs = String.concat "\n\n" [type_queries ; numeric_ops; misc_ops; apply_impl; cons_impl; car_impl; cdr_impl; set_car_impl; set_cdr_impl];;
